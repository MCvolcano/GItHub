				...
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td>
								<input type="text" id="nameinput" name="name" class="InputStyle" value="${param.name}"/> *
								<input type="hidden" id="idinput" name="cid" value="${param.id}" />
							</td>
						</tr>
					</table>
				</div>
...
<script type="text/javascript">
	...
	function updateClick(){
		var params = {id:$("#idinput").val(),name:$("#nameinput").val(),method:"updatec"};
		$.ajax({
			type:"post",
			url:"/Restaurant/update?method=updatec",
			data:params,
			dataType:"json",
